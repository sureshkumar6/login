...
const translations = [
  {
    ...
    english:
      "All the Upanishads are cows, Lord Krishna is the Cowherd, Arjuna is the wise Calf and the nectar of the Bhagavadgītā is the greatest Milk.",
  },
  {
    hindi:
  ...
  const setDailyShloka = () => {
    ...
    if (storedShloka && storedShloka.date === today) {
      ...
      localStorage.setItem(
        "dailyShloka",
        JSON.stringify({ date: today, shloka: newShloka })
      );
      setShloka(newShloka);
    }
  };
  ...
  return (
    <div className="home-container">
      ...
      <div className="firstCard ">
        <div className="shloka-box card-box">
          <h2>
            <span>📖</span>Thought of the Day
          </h2>
          {shloka.hindi && (
        ...
        {/* Announcements */}
        <div className="announcements card-box">
          <h2>📢 Announcements</h2>
      ...
      <div className="status-section card-box">
